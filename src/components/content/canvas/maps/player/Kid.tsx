...
export function Kid({ player, position }: ModelProps) {
  ...
  const { scene, materials, animations } = useGLTF('/models/Steve.glb') as GLTFResult;

  const clone = useMemo(() => SkeletonUtils.clone(scene) as THREE.Scene, [scene]);
